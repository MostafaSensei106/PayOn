...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<TransactionItemEntity> requests)?  success,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.requests);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<TransactionItemEntity> requests)  success,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.requests);case Failure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<TransactionItemEntity> requests)?  success,TResult? Function( String message)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class _Initial implements RequestMoneyState {
  const _Initial();
...
class Loading implements RequestMoneyState {
  const Loading();
...
class Success implements RequestMoneyState {
  const Success({required final  List<TransactionItemEntity> requests}): _requests = requests;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&const DeepCollectionEquality().equals(other._requests, _requests));
}
...
@override
String toString() {
  return 'RequestMoneyState.success(requests: $requests)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $RequestMoneyStateCopyWith<$Res> {
  factory $SuccessCopyWith(Success value, $Res Function(Success) _then) = _$SuccessCopyWithImpl;
@useResult
$Res call({
 List<TransactionItemEntity> requests
});
...
class Failure implements RequestMoneyState {
...
@override
String toString() {
  return 'RequestMoneyState.failure(message: $message)';
}
