...
part of 'account_type_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccountTypeState<T>);
}
...
/// @nodoc
class $AccountTypeStateCopyWith<T,$Res>  {
$AccountTypeStateCopyWith(AccountTypeState<T> _, $Res Function(AccountTypeState<T>) __);
}


/// Adds pattern-matching-related methods to [AccountTypeState].
extension AccountTypeStatePatterns<T> on AccountTypeState<T> {
...
class _Initial<T> implements AccountTypeState<T> {
  const _Initial();
...
@override
String toString() {
  return 'AccountTypeState<$T>.initial()';
}
...
class Loading<T> implements AccountTypeState<T> {
  const Loading();
...
@override
String toString() {
  return 'AccountTypeState<$T>.loading()';
}
...
class Success<T> implements AccountTypeState<T> {
...
@override
String toString() {
  return 'AccountTypeState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AccountTypeStateCopyWith<T, $Res> {
...
class Failure<T> implements AccountTypeState<T> {
...
@override
String toString() {
  return 'AccountTypeState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $AccountTypeStateCopyWith<T, $Res> {
