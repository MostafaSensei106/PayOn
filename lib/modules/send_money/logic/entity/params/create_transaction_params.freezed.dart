...
mixin _$CreateTransactionParams {
 ...
 String get senderId; String get receiverId; double get amount; String get description; String? get paymentId; int get transactionTypeId; bool get isTransactionByPhone;
...
@override
int get hashCode => Object.hash(runtimeType,senderId,receiverId,amount,description,paymentId,transactionTypeId,isTransactionByPhone);

@override
String toString() {
  return 'CreateTransactionParams(senderId: $senderId, receiverId: $receiverId, amount: $amount, description: $description, paymentId: $paymentId, transactionTypeId: $transactionTypeId, isTransactionByPhone: $isTransactionByPhone)';
}
...
@useResult
$Res call({
 String senderId, String receiverId, double amount, String description, String? paymentId, int transactionTypeId, bool isTransactionByPhone
});
...
/// Create a copy of CreateTransactionParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? senderId = null,Object? receiverId = null,Object? amount = null,Object? description = null,Object? paymentId = freezed,Object? transactionTypeId = null,Object? isTransactionByPhone = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String senderId,  String receiverId,  double amount,  String description,  String? paymentId,  int transactionTypeId,  bool isTransactionByPhone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateTransactionParams() when $default != null:
return $default(_that.senderId,_that.receiverId,_that.amount,_that.description,_that.paymentId,_that.transactionTypeId,_that.isTransactionByPhone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String senderId,  String receiverId,  double amount,  String description,  String? paymentId,  int transactionTypeId,  bool isTransactionByPhone)  $default,) {final _that = this;
switch (_that) {
case _CreateTransactionParams():
return $default(_that.senderId,_that.receiverId,_that.amount,_that.description,_that.paymentId,_that.transactionTypeId,_that.isTransactionByPhone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String senderId,  String receiverId,  double amount,  String description,  String? paymentId,  int transactionTypeId,  bool isTransactionByPhone)?  $default,) {final _that = this;
switch (_that) {
case _CreateTransactionParams() when $default != null:
return $default(_that.senderId,_that.receiverId,_that.amount,_that.description,_that.paymentId,_that.transactionTypeId,_that.isTransactionByPhone);case _:
  return null;
...
class _CreateTransactionParams implements CreateTransactionParams {
  const _CreateTransactionParams({required this.senderId, required this.receiverId, required this.amount, required this.description, this.paymentId, this.transactionTypeId = 6, this.isTransactionByPhone = true});
...
/// Create a copy of CreateTransactionParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? senderId = null,Object? receiverId = null,Object? amount = null,Object? description = null,Object? paymentId = freezed,Object? transactionTypeId = null,Object? isTransactionByPhone = null,}) {
